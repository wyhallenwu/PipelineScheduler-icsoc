...
void ArcFaceInference::inference() {
    ...
    while (true) {
        ...
        // After inference, 1 buffer are filled with memory, which we need to carry to post processor.
        // We put the buffer into a vector along with their respective shapes for the post processor to interpret.
