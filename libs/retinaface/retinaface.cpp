...
int main(int argc, char **argv) {
    ...
    if (cont_args.cont_pipeConfigs[0].at("msvc_type") == MicroserviceType::DataSource) {
        agent = new RetinaFaceDataSource(cont_args.cont_name, cont_args.cont_port, cont_args.cont_devIndex, cont_args.cont_logPath, cont_args.cont_runmode, cont_args.cont_profilingConfigs);
    } else {
        agent = new RetinaFaceAgent(cont_args.cont_name, cont_args.cont_port, cont_args.cont_devIndex, cont_args.cont_logPath, cont_args.cont_runmode, cont_args.cont_profilingConfigs);
    }
